  ...
  return (
    <>
      ...
      <div className="w-full bg-[#E1E1E1] border-t border-[#BBBBBB]">
        <Breadcrumbs items={breadcrumbsItems} showDivider align="left" containerClassName="xl:px-[200px]" />
      </div>

      <div className="bg-[#E1E1E1] pt-[clamp(28px,4vw,56px)]">
        <div className="max-w-[1440px] mx-auto px-[16px] sm:px-[24px] xl:px-[200px]">
